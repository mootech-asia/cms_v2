...
- [ ] 2 共用元件:大廳 header 內層、遊戲卡/Rail/hero/promos/分類 tab、紀錄表 DataTable→手寫表、篩選、modal
- [ ] 3 各頁專屬內容逐頁(會員內容殘餘 utility、大廳內容)
- [ ] 4 site.js 其餘 hook 同步 + 逐狀態驗
- [ ] 5 收尾:拆 app.css / 移除 primevue.css / purge 死碼(先掃 site.js 字面)
- 進度:2026-07-23 規模盤點 + 計畫 + **shell 全數語意化完成並驗證**;primevue.css 確認為活(勿刪)。
  下一段:大廳內容(index 776 class 最重),建議新 session 從本檔續做(鐵則 5)。
